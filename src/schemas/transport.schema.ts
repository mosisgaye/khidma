...
// Schéma de base sans les contraintes cross-field
const baseTransportOrderSchema = z.object({
  // Adresses
...
// Schéma avec validation cross-field
export const createTransportOrderSchema = baseTransportOrderSchema.refine(data => {
...
// Pour l'update, on utilise le schéma de base en partial (sans les contraintes cross-field)
export const updateTransportOrderSchema = baseTransportOrderSchema.partial();
